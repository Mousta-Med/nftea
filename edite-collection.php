...
if (isset($_POST['submit'])) {
    ...
    if (empty($img)) {
        ...
        $sql = "update collections set collection_nom ='$name', collection_artist ='$artist', 
  collection_image ='$img' where  collection_id = $id";
    }
...
<body>
    ...
    <div class="add-collection">
        <form class="collection-form" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="fname" name="collectionname" value="<?php echo $rows['collection_nom']; ?>"
                placeholder="Name" required>

            <label>Artist Name</label>
            <input type="text" id="lname" name="artistname" value="<?php echo $rows['collection_artist']; ?>"
