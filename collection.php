  ...
  <section>
    ...
    <div class="grid">
      ...
      <div class="card">
        ...
        <div class="edit">
          <a href="collection.php?delete=<?php echo $row['collection_id']; ?>"><svg class="rem"
          ...
          <a href="nft.php?show=<?= $row['collection_id'] ?>"><svg class="rem" xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="edite-collection.php?edite=<?= $row['collection_id'] ?>"><svg class="rem"
